$(function() {
	...
	$("#job_list").on('click', '.update',function() {
        ...
        var id = $(this).parents('ul').attr("_id");
        var row = tableData['key'+id];
		console.log('row.groupFlag:', row.groupFlag);
		...
		$("#updateModal .form textarea[name='alarmEmail']").val( row.alarmEmail );
		$("#updateModal .form select[name='groupFlag']").val(row.groupFlag).change();
	...
	$("#job_list").on('click', '.job_copy',function() {
		...
		$("#addModal .form textarea[name='alarmEmail']").val( row.alarmEmail );
	//	$("#updateModal .form select[name='groupFlag']").val(row.groupFlag).change();
		$("#addModal .form textarea[name='alarmSms']").val( row.alarmSms );
		$("#updateModal .form select[name='groupFlag']").val(row.groupFlag);
